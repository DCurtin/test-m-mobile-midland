...
.controller('TestCtrl', function($scope, $ionicPopup, $location, $sce, RegistrationService){
  ...
  $scope.getRandomFile = function(){
    ...
    var encoder = new TextEncoder('iso-8859-2', {NONSTANDARD_allowLegacyEncoding: true});
    ...
    xhr.onload = function(result) {
        ...
        if (this.status == 200) {
          ...
          var blob=new Blob([encodedText], {type: 'text/plain;charset=WINDOWS-1252;', encoding:'WINDOWS-1252'});
